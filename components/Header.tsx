...
const Search = () => {
  return (
    <div className="flex items-stretch h-10">
      ...
      <input type="text" placeholder="Search the atlas" className="pl-2 bg-transparent text-white"/>
...
const Header = () => (
  <header className="absolute z-10 w-full flex justify-between">
    <div className="p-10 w-1/3 text-white">
      ...
      <h2 className="text-xl">A library of land ownership and tenure models across time and geography</h2>
